...
fun GyroscopeApp(
    ...
    val wsPort = remember { mutableStateOf("8765") }
    ...
    LaunchedEffect(Unit) {
        webSocketClient.setOnLatencyUpdate { lat ->
    ...
    MaterialTheme(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    "Control your cursor with gyroscope",
                    fontSize = 14.sp,
                    color = Color(0xFF999),
                ...
                if (!isConnected.value) {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(20.dp)) {
                            ...
                            Button(
                                onClick = {
                                    webSocketClient.connect(serverIp.value, wsPort.value.toInt()) {
                                        isConnected.value = true
                                        gyroSensorManager.start()
                                        gyroSensorManager.setOnOrientationChange { a, b, g ->
                                            alpha.value = a
                                            beta.value = b
                                            gamma.value = g
                                            if (isConnected.value) {
                                                webSocketClient.sendMotion(a, b, g, sensitivity.value)
                                            }
                                        }
                                    }
                                },
